    ...
    <div className="container">
      ...
      <div className="selction2">
        <div className="section2-title py-5 px-12 md:py-24 md:px-48" data-aos="zoom-in">
          ...
          <p className="text-base md:text-3xl font-medium txt-blue ">
        ...
        <div className="wrapper-image">
          <div className="flex-image-box">
            <div className="showcase-item">
              ...
              <div className="item-sub item-border font-medium txt-blue text-sm md:text-base p-6 md:p-12 ">
            ...
            <div className="showcase-item">
              ...
              <div className="item-sub font-medium txt-blue text-sm md:text-base  p-6 md:p-12 ">
