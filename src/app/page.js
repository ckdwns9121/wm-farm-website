    ...
    <div className="container">
      <div className="section1 px-5 py-24 md:py-48 md:px-12">
        ...
        <div>
          ...
          <div className="text-background" data-aos="fade-up">
            <div className="blur-background"></div>
            <h2 className="relative txt-blue text-2xl md:text-5xl lg:text-6xl font-bold">
              신선한 도시, 즐거운 농장
            </h2>
          </div>
        </div>
      ...
      <div className="selction2">
        <div
          className="section2-title py-5 px-12 md:py-24 md:px-48"
          data-aos="zoom-in"
        >
          <p className="text-base md:text-3xl font-semibold txt-darkgreen ">
            더블유엠팜 쇼케이스 식물재배기
          </p>
          <p className="text-xl md:text-5xl font-bold txt-blue md:pt-4 pb-8 ">
            다양하게 활용할 수 있습니다
          </p>
          <p className="text-base md:text-3xl font-medium txt-blue break-keep">
            직접 식물을 기르며 어디서든 자연을 체험하고 정서적인 안전과 힐링을
            느껴보세요
          </p>
        </div>
              ...
              <div className="relative">
                ...
                <span className="absolute bottom-0 right-0">
                  <span className="badge-container left-badge">
                    <span className="badge-text text-sm font-semibold">
                      노인복지관 / 지자체
                    </span>
                  </span>
                </span>
              ...
              <div className="relative">
                ...
                <div className="absolute left-0 bottom-0">
                  <div className="badge-container ">
                    <div className="badge-text text-sm font-semibold">
                      학교 / 교육기관
                    </div>
                  </div>
                </div>
      ...
      <div className="section3">
        <div className="bg-green flex-center speech-bubble">
          <span
            className="txt-white  text-white text-sm md:text-base lg:text-xl"
            data-aos="fade-up"
          >
            빛과 물과 온도와 바람까지 알아서 제공해주는 식물재배기
          </span>
          <h1
            className="txt-blue text-3xl md:text-4xl lg:text-6xl font-bold"
            data-aos="fade-up"
          >
            더블유엠팜 쇼케이스
          </h1>
      ...
      <div className="section4">
        <div className="bg-green flex-center speech-bubble">
          <h1
            className="text-white text-xl md:text-4xl lg:text-6xl font-bold"
            data-aos="fade-up"
          >
            더블유엠팜 쇼케이스의 특별함!
          </h1>
      ...
      <div className="section5 bg-sky  py-6 pb-8 md:py-6 lg:py-6 relative">
        <div className="text-center">
          ...
          <p
            className="text-lg md:text-2xl lg:text-5xl font-bold txt-blue font-bold pb-4"
            data-aos="fade-up"
          >
        ...
        <div className="relative">
          ...
          <div className="absolute break-keep bottom-0 text-xs md:bottom-4 xl:bottom-4 left-4 font-semibold md:text-sm pr-4">
            *해당 색상은 이해를 돕기 위한 것으로 조명의 정도에 따라 색상이 다를
            수 있습니다.
          </div>
        </div>
      </div>
      <div className="section6">
        ...
        <div className="model-list bg-sky px-4 py-8 md:px-8 md: py-12">
          <div className="model-item">
            <span className="text-lg md:text-xl lg:text-2xl font-bold txt-blue">
              S800모델
            </span>
            <Image
        ...
        <div className="button-wrap py-4 md:py-12">
          <div className="buy-button">
            <a
              ...
              href="https://smartstore.naver.com/wmassi"
            >
              구매하기
            </a>
          </div>
